...
class PropertyPublishedManager(models.Manager):
    def get_queryset(self):
        return (
            ...
            .get_queryset().filter(published_status=True)
        )
...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=100, default="Faisalabad")
    postal_code = models.CharField(verbose_name=_("Postal Code"), max_length=100, default="38000")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="Street Address")
    property_number = models.IntegerField(verbose_name=_("Property Number"), validators=[MinValueValidator(1)], default=290)
    ...
    tax = models.DecimalField(
        verbose_name=_("Property Tax Percentage"),
        max_digits=6,
        decimal_places=2,
        default=0.15,
        help_text="Property Tax Percentage"
    )
    plot_area = models.DecimalField(
        verbose_name=_("Plot Area in square meters"),
        max_digits=8,
        decimal_places=2,
        default=0.0
    )
    ...
    def final_property_price(self):
        ...
        tax_amount = round(tax_percent * property_price, 2)
