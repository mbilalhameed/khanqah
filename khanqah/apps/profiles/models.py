...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+923362416168"
    )
    ...
    license = models.CharField(
        verbose_name=_("Khanqah License"), max_length=20, blank=True, null=True
    )
    ...
    country = CountryField(
        verbose_name=_("Country"), default="PK", blank=False, null=False
    )

    city = models.CharField(
        verbose_name=_("City"), max_length=180, default="Lahore", blank=False, null=False
    )
